...
import assignment5_styles from "../styles/assignment5_styles.module.css";
...
function AirlineRoutes(){
    ...
    return <Container >
        <Row className={"justify-content-md-left"}>
            <Col lg={10} >
                <h1 className={assignment5_styles.h1Style}>Airlines Routes</h1> 
            </Col>
        </Row>  
        <Row className={"justify-content-md-left"}>
        <Col lg={4}>
            <h2>Airlines</h2>
            <svg className={assignment5_styles.svgStyle} id={"barchart"} width={barchart_width} height={barchart_height}>
        ...
        <Col lg={4} >
            <h2>Airports</h2>
            <svg className={assignment5_styles.svgStyle} id={"map"} width={map_width} height={map_height}>
